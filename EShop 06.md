...
Видим, что получили Code - 503, указанный нам текст ошибки и всё так же в консоли мы "залогировали" исключение  
Важно обратить внимание, что всегда важно в таких ситуациях где-то фиксировать исключение - чтобы понимать, какая реально была проблема. Т.к. когда клиент АПИ придет с текстом ошибки, если он будет очень общий и использоваться в многих местах кода - может не оказаться возможности найти проблемное место, стек трейс из исключения позволяет понять место проблемы более чекто.  
Для фиксации исключений нужно использовать логи и метрики, о которых мы поговорим далее по курсу. А вот отдавать их прямо клиенту не очень хорошо, хотя бывают разные ситуации.  
